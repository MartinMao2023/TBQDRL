...
# from task_wrappers.trajectory_following import AntLineWrapper
from task_wrappers.velocity_keeping import AntVelocityWrapper
...
env = AntVelocityWrapper(env=env, v_max=3.0)
...
def training_loop(
    ...
    return new_carry, (
        ...
        aux_data.training_data.coef,
        aux_data.training_data.raw_coef,
...
for i in range(int(num_iterations / log_period)):
    ...
    wandb.log({
        ...
        "coef": iteration_coef[-1],
        "raw_coef": iteration_raw_coef[-1],
