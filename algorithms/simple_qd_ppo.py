...
class QDPPO:
    ...
    def state_update(
        ...
        policy_opt_state = policy_opt_state._replace(
            hyperparams={**policy_opt_state.hyperparams, 'learning_rate': current_std * 1e-3}
        )
        # policy_opt_state = optax.set_hyperparams(policy_opt_state, learning_rate=current_std * 1e-3)
